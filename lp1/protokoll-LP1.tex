...
Dessutom informerar Talman Ruben Seyer om att Talmanspresidiet föreslår en matpaus om mötet ser ut att gå över 8:00, men att beslut om ajourneringar är upp till sektionsmötet.
...
Han får svaret att tillstyrkanden på bordläggning gäller de förtroendeinvalda.
\begin{beslut}
...
\begin{beslut}
    \item med dela på besluten kring ansvarsfrihet mellan ekonomiskt ansvariga och resterande.
\end{beslut}
\begin{beslut}
...
De har även tagit hand om automaterna och planerat (men inte arrat) en filpperresa.
Till sist har de även letat efter en flaska Åke, och sett till att inte snåla med spriten under slutet av verksamhetsåret.
Alex Golic undrar om de hittade en flask Åke.
Therese svarar att den finns i Focumaten i Focrummet.
Felix Augustsson undrar varför det nya presidiet inte fått hattar.
Therese tycker att de har gett hattar till presidiet, men får invändningen att det bara var det tidigare presidiet som fått hattar.
\begin{beslut}
...
\subsubsection{Verksamhetsberättelse}
Tidigare Sexmästare Jonas Bohlin var sexmästare tycker att det inte finns så mycket att säga.
Han tyckte att det gick bra.
Sedan kom corona, vilket skadade aspningen och sabbade ekonomin.
Men det till trotts arrade de Gasquer, ET-raj samt gröt- och sopp-luncher.
\begin{beslut}
    \item med godkännande lägga \hyperlink{bilagor/f6/vb.pdf.1}{verksamhetsberättelsen} till handlingarna.
\end{beslut}

\subsubsection{Revisionsberättelse}
Revisor Nils Patriksson har inte så mycket att säga eftersom han tycker det ser bra ut.
\begin{beslut}
...
\subsubsection{Verksamhetsberättelse}
Tidigare Överste Axel Prebensen säger att DP fixat Focus, klätt om soffor, hållit i Nollanstäd samt arrat Pubrundor alla läsperioder utom sista då de istället fick ett budgetbortfall.
...
\subsubsection{Verksamhetsberättelse}
Tidigare Sektionsordförande Fredrik Meisingseth får ta över, tidigare VIce sektionsordförande Tarek Alhaskir inte är där.
Han meddelar att Styret styrt sektionen, vilket har gått bra.
\begin{beslut}
...
Han presenterar att det gick rätt bra ekonomiskt på sektionen.
...
\subsubsection{Revisionsberättelse}
Revisor Nils Patriksson säger att det ser bra ut, men att det finns några sista detaljer som behöver fixas innan ansvarsfrihet bör beviljas.
\begin{beslut}
    \item med godkännande lägga \hyperlink{bilagor/styret/rb.pdf.1}{revisionsberättelsen} till handlingarna.
\end{beslut}

\subsubsection{Ansvarsfrihet}
Nils tillstyrker bordläggande av ansvarsfrihet till nästkommande sektionsmöte.
David Winroth tycker återigen, med diskussionen från ett år sedan som bakgrund, att ansvarsfriheten ska delas upp mellan ekonomiskt ansvariga och övriga förtroendeinvalda.
\begin{beslut}
    \item med dela på besluten kring ansvarsfrihet mellan ekonomiskt ansvariga och resterande.
\end{beslut}
\begin{beslut}
...
Formuleringen antydde att Styret skulle kontrollera SNFs arbete, vilket de ogillade.
...
David informerar om att budgeten ser annorlunda ut i år eftersom han har lagt in föreningarnas budgetar i sektionens budget.
...
Sexmästare Ludwig Gustavsson gissar att alla på sekttionsmötet läst deras verksamhetsplan.
Det till trotts vill han förtydliga att det i år är ett extra fokus på att synas på sektionen, på grund av rådande restriktioner.
\begin{beslut}
...
Emelie Björkman undrar varför han är intresserad av SNFs arbete.
...
\begin{ofraga} \label{uppriven-budget}
    ...
    \begin{beslut}
        ...
        \item fastställa \hyperlink{bilagor/styret/ny-budget.pdf.1}{budgeten med det tidigare ändringsyrkandet}, samt vidare ändringar:
        \begin{itemize}
...
För att reda ut det trycker han prompt ner nyckeln i myntinkastet, men upptäcker snabbt att han inte får ut den eftersom nyckeln själv leder till nyckelkassan.
...
\begin{minipage}{0.45\textwidth}
    \begin{center}
        ...
        %\line(1,0){150}\\
        \footnotesize Ruben Seyer\\ %%Talman
        Talman\\[3cm]
        %\digsigfield{4.5cm}{1.5cm}{NN}
        %\line(1,0){150}\\
        \footnotesize Joseph Löfving\\ %%Justerare
        Justerare
        \end{center}
        \end{minipage}
        \begin{minipage}{0.45\textwidth}
        ...
        %\digsigfield{4.5cm}{1.5cm}{NN} 
        %\line(1,0){150}\\
        \footnotesize Felix Augustsson\\ %%Mötessekreterare
        Sekreterare\\[3cm]
        %\digsigfield{4.5cm}{1.5cm}{NN}
        %\line(1,0){150}\\
        \footnotesize David Winroth\\ %%Justerare
        Justerare
    \end{center}
\end{minipage}
...
\begin{bilagor}
    ...
    %\addbilagawatermark{test}
    \bilaga{Budget 20/21}{styret/budget.pdf}
    %\removebilagawatermark
